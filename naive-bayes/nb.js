...
// let prediction = naiveBayes('./kills.csv', 'firstHalf', {
//     Where: 'Casablanca Streets',
//     Who: 'Russian Mobster',
//     Weapon: 'Knife'
// });
...
module.exports = (path, positiveAttribute, traits) => {
    return naiveBayes('./kills.csv', positiveAttribute, traits);
}